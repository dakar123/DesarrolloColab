...
const createTables = async () => {
  ...
  try {
    ...
    await client.query(`CREATE INDEX IF NOT EXISTS idx_productos_stock ON productos(stock);`);
    ...
    if (count === 0) {
      ...
      await client.query(`SELECT setval('productos_id_seq', (SELECT MAX(id) FROM productos));`);
